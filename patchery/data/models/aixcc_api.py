...
class SARIFMetadata(ShellphishBaseModel):
    ...
    assessment: Assessment = Field(
        description="Assessment verdict", default=Assessment.AssessmentCorrect
    )
...
class PatchSubmissionResponse(ShellphishBaseModel):
    ...
    project_id: PDT_ID | None = Field(
        description="PDT identifier for the project", default=None
    )
